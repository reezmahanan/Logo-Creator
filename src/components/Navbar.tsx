...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const handleExportSVG = () => {
    ...
    downloadLink.download = `${config.companyName.toLowerCase()}-logo.svg`;
    ...
    image.onload = () => {
      ...
      if (context) {
        ...
        try {
          ...
          downloadLink.download = `${config.companyName.toLowerCase()}-logo.png`;
          document.body.appendChild(downloadLink);
          downloadLink.click();
          document.body.removeChild(downloadLink);
        } catch (err) {
  ...
  const generatePureHtmlCss = (): string => {
    ...
    const fontStyle = `font-family: ${config.companyNameFont}; font-size: ${config.companyNameSize}px; font-weight: ${config.companyNameWeight}; letter-spacing: ${config.companyNameLetterSpacing}px;`;
    const textColor = config.companyNameGradient 
